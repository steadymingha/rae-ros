...
#include "rae_msgs/msg/detail/led_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rae_msgs::msg::LEDControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rae_msgs::msg::LEDControl & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const rae_msgs::msg::LEDControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rae_msgs::msg::LEDControl *>(
    untyped_ros_message);
...
{
  return &rae_msgs::msg::typesupport_fastrtps_cpp::_LEDControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rae_msgs, msg, LEDControl)() {
  return &rae_msgs::msg::typesupport_fastrtps_cpp::_LEDControl__handle;
}
