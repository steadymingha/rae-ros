...
class PlayAudio_Request(metaclass=Metaclass_PlayAudio_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.mp3_file = kwargs.get('mp3_file', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.mp3_file != other.mp3_file:
            return False
        return True
    ...
    @builtins.property
    def mp3_file(self):
        """Message field 'mp3_file'."""
        return self._mp3_file

    @mp3_file.setter
    def mp3_file(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'mp3_file' field must be of type 'str'"
        self._mp3_file = value
...
class Metaclass_PlayAudio(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rae_msgs.srv import _play_audio
...
class PlayAudio(metaclass=Metaclass_PlayAudio):
    from rae_msgs.srv._play_audio import PlayAudio_Request as Request
    from rae_msgs.srv._play_audio import PlayAudio_Response as Response
