...
bool rae_msgs__msg__led_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rae_msgs.msg._led_control.LEDControl", full_classname_dest, 36) == 0);
  }
  rae_msgs__msg__LEDControl * ros_message = _ros_message;
  {  // header
  ...
  {  // data
    ...
    if (!std_msgs__msg__ColorRGBA__Sequence__init(&(ros_message->data), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create std_msgs__msg__ColorRGBA__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    std_msgs__msg__ColorRGBA * dest = ros_message->data.data;
  ...
  {  // single_led_n
    PyObject * field = PyObject_GetAttrString(_pymsg, "single_led_n");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->single_led_n = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // control_type
...
{
  /* NOTE(esteve): Call constructor of LEDControl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rae_msgs.msg._led_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LEDControl");
  ...
  {  // single_led_n
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->single_led_n);
    {
      int rc = PyObject_SetAttrString(_pymessage, "single_led_n", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
