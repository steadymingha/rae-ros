...
static const _PlayAudio_Request_type_support_symbol_names_t _PlayAudio_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rae_msgs, srv, PlayAudio_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rae_msgs, srv, PlayAudio_Request)),
  }
};
...
{
  return &::rae_msgs::srv::rosidl_typesupport_cpp::PlayAudio_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rae_msgs, srv, PlayAudio_Request)() {
  return get_message_type_support_handle<rae_msgs::srv::PlayAudio_Request>();
}
...
static const _PlayAudio_Response_type_support_symbol_names_t _PlayAudio_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rae_msgs, srv, PlayAudio_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rae_msgs, srv, PlayAudio_Response)),
  }
};
...
{
  return &::rae_msgs::srv::rosidl_typesupport_cpp::PlayAudio_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rae_msgs, srv, PlayAudio_Response)() {
  return get_message_type_support_handle<rae_msgs::srv::PlayAudio_Response>();
}
...
static const _PlayAudio_type_support_symbol_names_t _PlayAudio_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rae_msgs, srv, PlayAudio)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rae_msgs, srv, PlayAudio)),
  }
};
...
{
  return &::rae_msgs::srv::rosidl_typesupport_cpp::PlayAudio_service_type_support_handle;
}
