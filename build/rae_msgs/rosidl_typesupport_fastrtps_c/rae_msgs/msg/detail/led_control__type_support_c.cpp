...
#include "rae_msgs/msg/detail/led_control__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/color_rgba__functions.h"  // data
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_rae_msgs
...
using _LEDControl__ros_msg_type = rae_msgs__msg__LEDControl;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: single_led_n
  {
    cdr << ros_message->single_led_n;
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      std_msgs__msg__ColorRGBA__Sequence__fini(&ros_message->data);
    }
...
size_t get_serialized_size_rae_msgs__msg__LEDControl(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LEDControl__ros_msg_type * ros_message = static_cast<const _LEDControl__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name single_led_n
  {
    size_t item_size = sizeof(ros_message->single_led_n);
...
static uint32_t _LEDControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rae_msgs__msg__LEDControl(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rae_msgs
size_t max_serialized_size_rae_msgs__msg__LEDControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _LEDControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rae_msgs__msg__LEDControl(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rae_msgs, msg, LEDControl)() {
