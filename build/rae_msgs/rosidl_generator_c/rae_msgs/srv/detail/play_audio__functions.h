...
#ifndef RAE_MSGS__SRV__DETAIL__PLAY_AUDIO__FUNCTIONS_H_
#define RAE_MSGS__SRV__DETAIL__PLAY_AUDIO__FUNCTIONS_H_
...
#include "rae_msgs/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_rae_msgs
bool
 ...
 * calls
 * rae_msgs__srv__PlayAudio_Request__init().
...
/**
 * It calls
 * rae_msgs__srv__PlayAudio_Request__fini()
 ...
 * rae_msgs__srv__PlayAudio_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rae_msgs__srv__PlayAudio_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rae_msgs__srv__PlayAudio_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rae_msgs
...
/**
 * It calls
 * rae_msgs__srv__PlayAudio_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rae_msgs
...
/**
 * It allocates the memory for the array and calls
 * rae_msgs__srv__PlayAudio_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rae_msgs
...
/**
 * It calls
 * rae_msgs__srv__PlayAudio_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RAE_MSGS__SRV__DETAIL__PLAY_AUDIO__FUNCTIONS_H_
