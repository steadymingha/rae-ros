...
static const _PlayAudio_Request_type_support_symbol_names_t _PlayAudio_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rae_msgs, srv, PlayAudio_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rae_msgs, srv, PlayAudio_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rae_msgs, srv, PlayAudio_Request)() {
  return &::rae_msgs::srv::rosidl_typesupport_c::PlayAudio_Request_message_type_support_handle;
}
...
static const _PlayAudio_Response_type_support_symbol_names_t _PlayAudio_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rae_msgs, srv, PlayAudio_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rae_msgs, srv, PlayAudio_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rae_msgs, srv, PlayAudio_Response)() {
  return &::rae_msgs::srv::rosidl_typesupport_c::PlayAudio_Response_message_type_support_handle;
}
...
static const _PlayAudio_type_support_symbol_names_t _PlayAudio_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rae_msgs, srv, PlayAudio)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rae_msgs, srv, PlayAudio)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rae_msgs, srv, PlayAudio)() {
  return &::rae_msgs::srv::rosidl_typesupport_c::PlayAudio_service_type_support_handle;
}
